...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			multiTooltipKeyBackground: '#fff',
                        ...
                        // if true, we need to lager datasetLabelWidth to adapt your label
                        // just for Line
                        // add by wing
                        datasetLabelWidth: 0,
			...
			if (ChartElements.length > 0){
				...
				if (this.datasets && this.datasets.length > 1) {
					var dataArray,
						dataIndex;
                                        var datasetLabels = [];
                                        var showDatasetLabel = this.options.showDatasetLabel;
							...
							helpers.each(Elements, function(element) {
								...
								tooltipColors.push({
									...
									stroke: element._saved.strokeColor || element.strokeColor
                                                                ...
                                                                if(this.options.showDatasetLabel){
                                                                    datasetLabels.push(element._saved.datasetLabel);
                                                                }
					...
					new Chart.MultiTooltip({
						...
						ctx: this.chart.ctx,
                                                ...
                                                datasetLabelWidth: this.options.datasetLabelWidth
					}).draw();
	...
	Chart.MultiTooltip = Chart.Element.extend({
		initialize : function(){
			...
			this.width = longestTextWidth + (this.xPadding*2) + this.datasetLabelWidth;
			...
			helpers.each(this.labels,function(label,index){
				ctx.fillStyle = this.textColor;
                                if(this.showDatasetLabel){
                                    ctx.fillText(this.datasetLabels[index],this.x + this.xPadding, this.getLineHeight(index + 1));
                                }
				ctx.fillText(label,this.x + this.xPadding + this.datasetLabelWidth + this.fontSize + 3, this.getLineHeight(index + 1));
				...
				ctx.fillRect(this.x + this.xPadding + this.datasetLabelWidth, this.getLineHeight(index + 1) - this.fontSize/2, this.fontSize, this.fontSize);
